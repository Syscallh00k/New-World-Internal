...
local function safe_sort(tbl, comp)
...
safe_sort(buses, function(a, b) return a.name < b.name end)
...
safe_sort(data_tables, function(a, b) return a.name < b.name end)
...
safe_sort(other, function(a, b) return a.name < b.name end)
